...
class SimpleMazeGrid(gym.Env):
    ...
    def step(self, action):
        ...
        if self.final_goal_pos is not None:
            ...
            if (cur_goal_dist < self.terminated_radius) and heading_ok and (self.current_wp_index >= last_wp):
    ...
    def auto_step_path_tracking(self):
        ...
        if self.final_goal_pos is not None:
            ...
            if (cur_dist < self.terminated_radius) and heading_ok and (self.current_wp_index >= last_wp):
                self.terminated = True
